...
HypercubeEtalon. It is not a git submodule. Upstream is the public HypercubeCNN
project.
...
| `CMakeLists.txt` | **HypercubeEtalon only** — how this tree is built *inside* Etalon. Not the upstream project CMake. |
| `VENDORED.md` | This note |

No examples, Python package, tests, or docs from HypercubeCNN — only the core
needed to link HypercubeEtalon.
...
3. Leave this directory’s `CMakeLists.txt` alone unless the Etalon build needs a change.
